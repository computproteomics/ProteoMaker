...
resultFilePath <- "InSilicoWorkshop/UPS1-like_output"
...
repportName <- paste0(resultFilePath,"/UPS1-like_Report_BatchAnalysis_", gsub(":|[[:space:]]", "_", format(Sys.time(), "%Y%b%d%X")))
...
paramProteoformAb <- list(
  "QuantNoise" = seq(0,0.3,0.6),
  # "DiffRegFrac" = c(0.1,0.3,0.5),
  # "DiffRegMax" = seq(0.5, 2, 0.5),
  # "UserInputFoldChanges" = NULL,
  "UserInputFoldChanges" = list("NumRegProteoforms" = rep(96, 3),
...
paramDigest <- list(
  ##### Digestion
  "Enzyme" = c("trypsin", "trypsin.strict"),
  "PropMissedCleavages" = c(0, 0.1, 0.3), 
  "MaxNumMissedCleavages" = 4,
  "PepMinLength" = 7,
  "PepMaxLength" = 30,
  "LeastAbundantLoss" = 0,
  "EnrichmentLoss" = c(0,0.2),
...
paramMSRun <- list(
  ##### MSRun
  "PercDetectedPep" = seq(0,0.3,0.6),
  "PercDetectedVal" = seq(0,0.3,0.6),
  "WeightDetectVal" = c(0,0.5,1),
  "MSNoise" = c(0, 0.25, 0.5),
  "WrongIDs" = c(0, 0.01, 0.05),
