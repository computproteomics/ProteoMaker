...
```{r, include=FALSE}
# Do not execute code chunks during vignette builds
knitr::opts_chunk$set(eval = FALSE)
```

## Installation

Install ProteoMaker from source or your preferred repository before running the examples.
This vignette shows example code for running simulations; code execution is disabled during build.
...
Param$paramGroundTruth$RemoveNonModFormFrac <- 0   # keep unmodified counterpart -> 2 proteoforms total# Param$paramGroundTruth$NumReps <- c(3:5)
