...
paramProteoformAb <- list(
  "QuantNoise" = seq(0.1,0.9,0.1),
  "DiffRegFrac" = 0,
  "DiffRegMax" = 0,
  "UserInputFoldChanges" = NULL,
  "ThreshNAProteoform" = -100,
  "AbsoluteQuanMean" = 30.5, # default value: 30.5
  "AbsoluteQuanSD" = seq(2,5,0.5), # default value: 3.6
  "ThreshNAQuantileProt" = seq(0,0.6, 0.1)
)
paramDigest <- list(
  ##### Digestion
  "Enzyme" = "trypsin",
  ...
  "PepMinLength" = 7,
  "PepMaxLength" = 30,
  "LeastAbundantLoss" = seq(0, 0.6, 0.1),
  "EnrichmentLoss" = 0,
...
paramMSRun <- list(
  ##### MSRun
  "PercDetectedPep" = seq(0, 0.6, 0.1),
  "PercDetectedVal" = seq(0, 0.6, 0.1),
  "WeightDetectVal" = c(0,1,0.1),
  "MSNoise" = seq(0, 0.6, 0.1),
  "WrongIDs" = 0.01,
