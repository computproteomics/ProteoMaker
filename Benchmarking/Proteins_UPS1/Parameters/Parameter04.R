...
cat("Load Parameter04: Add minimal noise, and loss due to detection threshold (5% quantile).\n")
cat("Load Parameter04: Max 1 missed cleavages (occurence 20%), peptide length between 7 and 30.\n")
...
cat("The initial noise is set to", Param$QuantNoise, "on a normal distribution in log2 (mean = 0)\n")
...
Param$ThreshNAQuantileProt <- 0.05
