...
-   **Sum of Squared Residuals Towards Actual Fold-Changes** (`sumSquareDiffFCPep`, label: *Fold-change error (peptides)*): Fold-change error (ground truth vs. measured), computed as squared differences for log2 FC.
...
-   **Sum of Squared Residuals Towards Actual Fold-Changes** (`sumSquareDiffFCProt`, label: *Fold-change error (proteins)*): Average squared error between simulated and measured log2 fold-changes.
...
-   **Sum of Squared Residuals Towards Actual Fold-Changes** (`sumSquareDiffFCModPep`, label: *Fold-change error (mod. peptides)*): Squared differences between simulated and measured log2 fold-changes of modified peptides.
...
| Fold-Change Error | sumSquareDiffFCPep | Fold-change error (peptides) | Peptide |
...
| Fold-Change Error | sumSquareDiffFCProt | Fold-change error (proteins) | Protein |
...
| Fold-Change Error (Mod Peptides) | sumSquareDiffFCModPep | Fold-change error (mod. peptides) | PTM |
