---
title: "PhosFake Benchmarks"
format: html
editor: visual
---


This document provides a detailed description of the benchmarks used in the PhosFake pipeline. PhosFake is a tool for generating an in-silico bottom-up LC-MS dataset from proteoforms. The pipeline simulates various stages of the experimental process, from the generation of ground truth data to mass spectrometry (MS) analysis and statistical testing. These benchmarks are essential for comparing the results and evaluating the performance of the pipeline. For more information about the project, visit [PhosFake on GitHub](https://github.com/veitveit/PhosFake).
